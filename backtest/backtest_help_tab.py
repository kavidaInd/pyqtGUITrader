...
class BacktestHelpTab(QWidget, ThemedMixin):
    """
    ...
    def __init__(self, parent=None):
        ...
        try:
            ...
            logger.critical(f"[BacktestHelpTab.__init__] Failed: {e}", exc_info=True)
            super().__init__(parent)
    ...
    def apply_theme(self, _: str = None) -> None:
        ...
        try:
            ...
            if header:
                header.setStyleSheet(f"color:{c.BLUE}; font-size:{self._ty.SIZE_BODY}pt; font-weight:bold; padding:{sp.PAD_MD}px;")
            ...
            logger.debug("[BacktestHelpTab.apply_theme] Applied theme")
        except Exception as e:
            logger.error(f"[BacktestHelpTab.apply_theme] Failed: {e}", exc_info=True)
    ...
    def _init_ui(self):
        ...
        # Style will be set in apply_theme

        # Create all content pages
        self._create_all_pages()

        splitter.addWidget(self.content_stack)
        splitter.setSizes([280, 720])  # 28% navigation, 72% content (design requirement)
    ...
    def _create_welcome_page(self) -> QWidget:
        ...
        header.setStyleSheet(f"color:{c.BLUE}; font-size:{ty.SIZE_XL}pt; font-weight:bold;")
        ...
        stats_layout.setSpacing(sp.PAD_LG)
        ...
        start_card = self._create_info_card(
            "🚀 Getting Started",
            [
                "1. Select a strategy",
                "2. Choose date range",
    ...
    def _create_info_card(self, title: str, items: List[str], title_color: str = None) -> QGroupBox:
        ...
        card.setStyleSheet(f"""
            QGroupBox {{
                ...
                padding-top: {sp.PAD_LG}px;
            }}
            QGroupBox::title {{
                color: {title_color or c.BLUE};
                left: {sp.PAD_MD}px;
            }}
        """)
        card_layout = QVBoxLayout(card)
        for item in items:
            card_layout.addWidget(QLabel(item))
        return card
    ...
    def _create_quick_start_page(self) -> QWidget:
        ...
        title.setStyleSheet(f"color:{c.BLUE}; font-size:{ty.SIZE_XL}pt; font-weight:bold;")
        layout.addWidget(title)

        # Steps
        steps_widget = QWidget()
        steps_layout = QVBoxLayout(steps_widget)
        steps_layout.setSpacing(sp.PAD_XL)
        ...
        for title_text, description in steps:
            ...
            title_label.setStyleSheet(f"color:{c.GREEN}; font-size:{ty.SIZE_BODY}pt; font-weight:bold;")
            step_layout.addWidget(title_label)

            desc_label = QLabel(description)
            desc_label.setStyleSheet(f"color:{c.TEXT_DIM}; font-size:{ty.SIZE_BODY}pt;")
    ...
    def _create_text_page(self, title: str, content: str) -> QWidget:
        ...
        """)
        text.setHtml(f"<h1 style='color:{c.BLUE};'>{title}</h1>\n\n{content}")
    ...
    def _create_strategy_tab_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Tips</h2>
            <ul>
    ...
    def _create_timeframes_tab_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Available Timeframes</h2>
            ...
            <h2 style='color:{c.GREEN}'>Important Notes</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>Best Practices</h2>
            <ul>
    ...
    def _create_instrument_tab_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Instrument Settings</h2>
            ...
            <h2 style='color:{c.GREEN}'>Date Range</h2>
    ...
    def _create_risk_tab_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Take Profit / Stop Loss</h2>
            ...
            <h2 style='color:{c.GREEN}'>Risk Options</h2>
            ...
            <h2 style='color:{c.GREEN}'>Advanced Risk Parameters</h2>
            ...
            <h2 style='color:{c.GREEN}'>Risk-Reward Considerations</h2>
            <ul>
    ...
    def _create_costs_tab_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Execution Costs</h2>
            ...
            <h2 style='color:{c.GREEN}'>Capital</h2>
            ...
            <h2 style='color:{c.GREEN}'>Impact on Results</h2>
            <ul>
    ...
    def _create_execution_tab_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Execution Options</h2>
            ...
            <h2 style='color:{c.GREEN}'>Volatility Source</h2>
    ...
    def _create_option_pricing_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Priority Chain</h2>
            <ol>
            ...
            <h2 style='color:{c.GREEN}'>Black-Scholes Model</h2>
            <p>The Black-Scholes formula for European options:</p>
            <div style='background:{c.BG_MAIN}; padding:15px; border-radius:8px; font-family:monospace;'>
            ...
            <h2 style='color:{c.GREEN}'>Input Parameters</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>OHLC Generation</h2>
    ...
    def _create_synthetic_data_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            f"""
            <h2 style='color:{c.GREEN}'>Why Synthetic Data?</h2>
            ...
            <h2 style='color:{c.GREEN}'>Visual Indicators</h2>
            ...
            <table width='100%' border='1' cellpadding='10' style='border-collapse: collapse;'>
                ...
                <tr>
                    ...
                    <td style='color:{c.GREEN};'>✓ (green)</td>
                    <td style='color:{c.YELLOW};'>⚗ (amber)</td>
                </tr>
                <tr>
                    <td><b>Trade Row Background</b></td>
                    <td>Normal</td>
                    <td style='background:{c.BG_ROW_B};'>Amber-tinted</td>
                </tr>
                <tr>
            ...
            <h2 style='color:{c.GREEN}'>Reliability Considerations</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>When Synthetic Data is Used</h2>
            <ul>
    ...
    def _create_entry_exit_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "🎯 Entry & Exit Logic",
            f"""
            <h2 style='color:{c.GREEN}'>Entry Logic</h2>
            ...
            <h2 style='color:{c.GREEN}'>Exit Logic (Priority Order)</h2>
    ...
    def _create_multi_tf_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>How It Works</h2>
            <ol>
            ...
            <h2 style='color:{c.GREEN}'>Analysis Tab Features</h2>
            ...
            <h2 style='color:{c.GREEN}'>Use Cases</h2>
            <ul>
    ...
    def _create_overview_tab_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Stat Cards</h2>
            ...
            <h2 style='color:{c.GREEN}'>Configuration Summary</h2>
    ...
    def _create_trade_log_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Column Guide</h2>
            ...
            <h2 style='color:{c.GREEN}'>Exit Reasons</h2>
            <ul>
    ...
    def _create_strategy_analysis_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Features</h2>
            ...
            <h2 style='color:{c.GREEN}'>Interpretation Guide</h2>
            <ul>
    ...
    def _create_equity_curve_tab_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>What to Look For</h2>
    ...
    def _create_candle_debug_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Detail Popup</h2>
    ...
    def _create_metrics_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            f"""
            <h2 style='color:{c.GREEN}'>Core Performance Metrics</h2>
            ...
            <h2 style='color:{c.GREEN}'>Trade Statistics</h2>
            ...
            <h2 style='color:{c.GREEN}'>Data Quality Metrics</h2>
    ...
    def _create_reading_equity_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            f"""
            <h2 style='color:{c.GREEN}'>Ideal Equity Curve Characteristics</h2>

            <div style='background:{c.BG_HOVER}; padding:15px; border-radius:8px; margin:15px 0;'>
                <h3 style='color:{c.GREEN};'>✅ Good Curve</h3>
                <ul>
            ...
            <div style='background:{c.BG_HOVER}; padding:15px; border-radius:8px; margin:15px 0;'>
                <h3 style='color:{c.RED};'>⚠️ Warning Signs</h3>
                <ul>
            ...
            <h2 style='color:{c.GREEN}'>Pattern Recognition</h2>
            ...
            <h2 style='color:{c.GREEN}'>Synthetic Data Impact</h2>
    ...
    def _create_black_scholes_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <div style='background:{c.BG_MAIN}; padding:20px; border-radius:8px; font-family:monospace; font-size:11pt; margin:15px 0;'>
            ...
            <h2 style='color:{c.GREEN}'>Parameters</h2>
            ...
            <h2 style='color:{c.GREEN}'>Assumptions & Limitations</h2>
            <ul>
    ...
    def _create_volatility_page(self) -> QWidget:
        ...
        c = self._c
        return self._create_text_page(
            "🌪️ Volatility Sources",
            f"""
            <p>The backtest engine supports two volatility sources for option pricing.</p>

            <h2 style='color:{c.GREEN}'>Option 1: India VIX (use_vix=True)</h2>
            ...
            <h2 style='color:{c.GREEN}'>Option 2: Historical Volatility (use_vix=False)</h2>
            ...
            <h2 style='color:{c.GREEN}'>Recommendations</h2>
            <ul>
    ...
    def _create_vix_vs_hv_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            f"""
            <h2 style='color:{c.GREEN}'>Key Differences</h2>
            ...
            <h2 style='color:{c.GREEN}'>When They Diverge</h2>
            ...
            <h2 style='color:{c.GREEN}'>Which is Better for Backtesting?</h2>
    ...
    def _create_expiry_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Weekly Expiry</h2>
            ...
            <h2 style='color:{c.GREEN}'>Monthly Expiry</h2>
            ...
            <h2 style='color:{c.GREEN}'>Time to Expiry Calculation</h2>
    ...
    def _create_synthetic_generation_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Bar Fraction</h2>
            <div style='background:{c.BG_MAIN}; padding:10px; border-radius:4px; font-family:monospace;'>
                bar_fraction = minutes_per_bar / (252 × 375)
            </div>

            <h2 style='color:{c.GREEN}'>Price Smoothing</h2>
    ...
    def _create_real_data_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Data Priority Chain</h2>

            <div style='background:{c.BG_MAIN}; padding:20px; border-radius:8px; margin:15px 0;'>
                <ol style='font-size:12pt;'>
                    <li><b style='color:{c.GREEN};'>REAL DATA</b> — If all four OHLC prices are present and positive</li>
                    <li><b style='color:{c.YELLOW};'>SYNTHETIC (Black-Scholes)</b> — When any price component missing</li>
                </ol>
            </div>

            <h2 style='color:{c.GREEN}'>Why Real Data is Preferred</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>When Real Data is Unavailable</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>Identifying Data Source</h2>
    ...
    def _create_tp_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "🎯 Take Profit (TP)",
            f"""
            <h2 style='color:{c.GREEN}'>What is Take Profit?</h2>
            ...
            <div style='background:{c.BG_MAIN}; padding:15px; border-radius:8px; font-family:monospace; margin:15px 0;'>
            ...
            <h2 style='color:{c.GREEN}'>Example</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>TP in Different Market Conditions</h2>
            <ul>
    ...
    def _create_sl_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "🛑 Stop Loss (SL)",
            f"""
            <h2 style='color:{c.GREEN}'>What is Stop Loss?</h2>
            ...
            <h2 style='color:{c.GREEN}'>Common Mistakes</h2>
            <ul>
    ...
    def _create_trailing_sl_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "🏃 Trailing Stop Loss",
            f"""
            <h2 style='color:{c.GREEN}'>What is a Trailing Stop?</h2>
            ...
            <h2 style='color:{c.GREEN}'>Benefits</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>Choosing Trailing SL %</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>Combining with Fixed TP/SL</h2>
    ...
    def _create_index_sl_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            f"""
            <h2 style='color:{c.GREEN}'>What is Index SL?</h2>
            ...
            <div style='background:{c.BG_MAIN}; padding:10px; border-radius:8px; font-family:monospace; margin:10px 0;'>
            ...
            <h2 style='color:{c.GREEN}'>When to Use Index SL</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>Choosing Index SL Points</h2>
            <ul>
    ...
    def _create_max_hold_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "⏱️ Max Hold Bars",
            f"""
            <h2 style='color:{c.GREEN}'>What is Max Hold?</h2>
            ...
            <h2 style='color:{c.GREEN}'>Why Use Max Hold?</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>Choosing Max Hold Values</h2>
            ...
            <h2 style='color:{c.GREEN}'>Considerations</h2>
            <ul>
    ...
    def _create_risk_reward_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "📊 Risk-Reward Ratios",
            f"""
            <h2 style='color:{c.GREEN}'>What is Risk-Reward Ratio?</h2>
            ...
            <h2 style='color:{c.GREEN}'>Required Win Rate by RR</h2>
            ...
            <h2 style='color:{c.GREEN}'>Common RR Configurations</h2>
            ...
            <h2 style='color:{c.GREEN}'>Choosing Your RR</h2>
            <ul>
    ...
    def _create_sideway_zone_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "⏸️ Sideway Zone Skip",
            f"""
            <h2 style='color:{c.YELLOW}'>What is the Sideway Zone?</h2>
            ...
            <h2 style='color:{c.GREEN}'>Why Skip It?</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>Should You Enable It?</h2>
    ...
    def _create_slippage_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "📉 Slippage",
            f"""
            <h2 style='color:{c.GREEN}'>What is Slippage?</h2>
            ...
            <h2 style='color:{c.GREEN}'>Why Slippage Happens</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>How It's Modeled</h2>
            ...
            <h2 style='color:{c.GREEN}'>Typical Slippage Values</h2>
            ...
            <h2 style='color:{c.GREEN}'>Impact on Strategy</h2>
            <ul>
    ...
    def _create_brokerage_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "💸 Brokerage",
            f"""
            <h2 style='color:{c.GREEN}'>What is Brokerage?</h2>
            <p>Brokerage is the fee charged by your broker for executing trades.</p>

            <h2 style='color:{c.GREEN}'>How It's Calculated</h2>
            ...
            <h2 style='color:{c.GREEN}'>Brokerage by Broker</h2>
    ...
    def _create_position_sizing_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "📊 Position Sizing",
            f"""
            <h2 style='color:{c.GREEN}'>What is Position Sizing?</h2>
            ...
            <h2 style='color:{c.GREEN}'>Position Value</h2>
            <div style='background:{c.BG_MAIN}; padding:15px; border-radius:8px; font-family:monospace; margin:15px 0;'>
                Position Value = Option Premium × Lot Size × Lots<br>
                Example: ₹100 × 50 × 2 = ₹10,000
            </div>

            <h2 style='color:{c.GREEN}'>Risk Per Trade</h2>
            <div style='background:{c.BG_MAIN}; padding:15px; border-radius:8px; font-family:monospace; margin:15px 0;'>
            ...
            <h2 style='color:{c.GREEN}'>Position Sizing Rules</h2>
    ...
    def _create_capital_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "💵 Capital Management",
            f"""
            <h2 style='color:{c.GREEN}'>Initial Capital</h2>
            <p>Starting capital for the backtest. All P&L calculations and drawdowns are based on this.</p>

            <h2 style='color:{c.GREEN}'>Key Metrics Based on Capital</h2>
            ...
            <h2 style='color:{c.GREEN}'>What's Good?</h2>
            ...
            <h2 style='color:{c.GREEN}'>Capital Allocation Considerations</h2>
            ...
            <h2 style='color:{c.GREEN}'>Reinvestment</h2>
    ...
    def _create_execution_interval_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "⚡ Execution Intervals",
            f"""
            <h2 style='color:{c.GREEN}'>What is Execution Interval?</h2>
            ...
            <h2 style='color:{c.GREEN}'>Interval Comparison</h2>
            ...
            <h2 style='color:{c.GREEN}'>Choosing Your Interval</h2>
    ...
    def _create_export_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "📤 Export Results",
            f"""
            <h2 style='color:{c.GREEN}'>What Can Be Exported?</h2>
            ...
            <h2 style='color:{c.GREEN}'>Auto-Export Feature</h2>
            ...
            <h2 style='color:{c.GREEN}'>Using Exported Data</h2>
    ...
    def _create_import_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            f"""
            <h2 style='color:{c.GREEN}'>What Can Be Imported?</h2>
            ...
            <h2 style='color:{c.GREEN}'>Sharing Backtest Configurations</h2>
            ...
            <h2 style='color:{c.GREEN}'>Future Features</h2>
    ...
    def _create_batch_testing_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Parameters to Test</h2>
    ...
    def _create_debugging_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "🔍 Debugging Tips",
            f"""
            <h2 style='color:{c.GREEN}'>1. Use Candle Debug Tab</h2>
            ...
            <h2 style='color:{c.GREEN}'>2. Check Skip Reasons</h2>
            ...
            <h2 style='color:{c.GREEN}'>3. Verify Signal Groups</h2>
...
logging.getLogger('backtest.backtest_engine').setLevel(logging.DEBUG)</pre>
            ...
            <h2 style='color:{c.GREEN}'>6. Entry/Exit Not Working</h2>
    ...
    def _create_log_analysis_page(self) -> QWidget:
        ...
        return self._create_text_page(
            "📊 Log Analysis",
            f"""
            <h2 style='color:{c.GREEN}'>Understanding Backtest Logs</h2>

            <h3>Per-Candle Assessment Logs</h3>
            <p>When debug logging is enabled, you'll see detailed per-candle output:</p>

            <pre style='background:{c.BG_MAIN}; padding:15px; border-radius:8px; font-family:monospace; font-size:{self._ty.SIZE_XS}pt;'>
────────────────────────────────────────────────────────
...
────────────────────────────────────────────────────────</pre>
            ...
            <pre style='background:{c.BG_MAIN}; padding:15px; border-radius:8px; font-family:monospace;'>
...
no_signal=800 | in_trade=120 | entries=11 | trades=8 | signals={{'BUY_CALL':8, 'WAIT':1420}}</pre>
    ...
    def _create_performance_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            f"""
            <h2 style='color:{c.GREEN}'>Why Backtests Can Be Slow</h2>
            ...
            <h2 style='color:{c.GREEN}'>Typical Performance</h2>
            ...
            <h2 style='color:{c.GREEN}'>Optimization Tips</h2>
            ...
            <h2 style='color:{c.GREEN}'>Progress Indicators</h2>
    ...
    def _create_setup_practices_page(self) -> QWidget:
        ...
        c = self._c
        return self._create_text_page(
            "🎯 Setting Up Backtests - Best Practices",
            f"""
            <h2 style='color:{c.GREEN}'>1. Start Simple</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>2. Verify Basic Functionality</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>3. Choose Appropriate Date Range</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>4. Set Realistic Costs</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>5. Enable Candle Debug for First Runs</h2>
            <p>This helps verify signals are firing as expected. Disable for longer runs to save disk space.</p>

            <h2 style='color:{c.GREEN}'>6. Document Your Setup</h2>
    ...
    def _create_overfitting_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Prevention Strategies</h2>
            ...
            <h2 style='color:{c.GREEN}'>Good Practices</h2>
            <ul>
    ...
    def _create_interpreting_results_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            f"""
            <h2 style='color:{c.GREEN}'>1. Look at the Whole Picture</h2>
            ...
            <h2 style='color:{c.GREEN}'>2. Examine the Equity Curve</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>3. Analyze Trade Log</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>4. Check Strategy Analysis</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>5. Consider Market Regimes</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>6. Reality Check</h2>
            <ul>
    ...
    def _create_risk_practices_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            f"""
            <h2 style='color:{c.GREEN}'>1. Always Use Stop Loss</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>2. Set Realistic Take Profit</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>3. Risk Per Trade</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>4. Monitor Drawdown</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>5. Diversify</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>6. Position Sizing Rules</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>7. Use Multiple Exit Types</h2>
            <ul>
    ...
    def _create_iterative_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            f"""
            <h2 style='color:{c.GREEN}'>The Development Cycle</h2>

            <div style='background:{c.BG_MAIN}; padding:20px; border-radius:8px; margin:15px 0; text-align:center;'>
                <b>1. IDEA → 2. IMPLEMENT → 3. BACKTEST → 4. ANALYZE → 5. REFINE → (repeat)</b>
            </div>

            <h2 style='color:{c.GREEN}'>Step 1: Start with a Hypothesis</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>Step 2: Implement in Strategy Editor</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>Step 3: Run Initial Backtest</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>Step 4: Analyze Results</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>Step 5: Refine</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>Step 6: Validate</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>Common Pitfalls to Avoid</h2>
            <ul>
    ...
    def _create_mistakes_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            f"""
            <h2 style='color:{c.GREEN}'>1. Over-Optimization</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>2. Ignoring Costs</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>3. Too Few Trades</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>4. Ignoring Market Regimes</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>5. Data Snooping</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>6. Ignoring Drawdowns</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>7. Too Many Rules</h2>
            <ul>
            ...
            <h2 style='color:{c.GREEN}'>8. Ignoring Data Quality</h2>
            <ul>
    ...
    def _create_shortcuts_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            <h2 style='color:{c.GREEN}'>Table Navigation (Trade Log, Candle Debug)</h2>
            <table width='100%' border='1' cellpadding='10' style='border-collapse: collapse;'>
                <tr style='background:{c.BG_HOVER};'><th>Shortcut</th><th>Action</th></tr>
            ...
            <h2 style='color:{c.GREEN}'>Search/Filter</h2>
            <table width='100%' border='1' cellpadding='10' style='border-collapse: collapse;'>
                <tr style='background:{c.BG_HOVER};'><th>Shortcut</th><th>Action</th></tr>
    ...
    def _create_glossary_page(self) -> QWidget:
        ...
        return self._create_text_page(
            ...
            f"""
            <table width='100%' border='1' cellpadding='10' style='border-collapse: collapse;'>
                <tr style='background:{c.BG_HOVER};'><th>Term</th><th>Definition</th></tr>
